...
const MiddleCliente = (cliente: any, position: any) => {
  const { name, profession, customerAddress, document } = cliente.cliente;
  ...
  return (
    <Draggable bounds={"parent"} defaultPosition={pos}>
      <div className=" w-full flex gap-10 px-10 cursor-move">
        <div className="flex flex-col justify-center text-center w-32 items-center">
          ...
          <span className="uppercase font-semibold">Cliente</span>
        </div>
